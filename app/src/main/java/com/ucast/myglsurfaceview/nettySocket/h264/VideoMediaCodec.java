...
public class VideoMediaCodec extends MediaCodecBase {
    ...
    private static String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Ucast/test1.h264";
...
//                        }
//                        h264data.setIDR(keyframe);
                        H264Queuemanager.getInstance().getOneH264Queue(0).addItem(keyframe);
                    }else{
//                        MainActivity.putData(outData,2,mBufferInfo.presentationTimeUs*1000L);
//                        if(outputStream != null){
//                            outputStream.write(outData, 0, outData.length);
//                        }
                        H264Queuemanager.getInstance().getOneH264Queue(0).addItem(outData);
                    }
